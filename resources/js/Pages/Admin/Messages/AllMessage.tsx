...
export default function AllUser({ contacts }: Props) {
    const {
        data,
        setData,
        delete: destroy,
    ...
    const deleteitem = (id: number) => (e: React.MouseEvent) => {
        ...
        destroy(route('message.destroy', id), {
            preserveScroll: true,
            onSuccess: () => {
            ...
            <div className="w-full flex justify-center px-4 py-6">
                <div className="dark:bg-stone-900 p-4  shadow-md rounded-xl overflow-hidden w-full max-w-6xl">
                    <div className='flex justify-between'>
                        <h1 className='text-white text-lg font-bold px-5 '>تمامی محصولات</h1>
                    ...
                    <button className='bg-yellow-400 py-2 mt-6 mb-6 
