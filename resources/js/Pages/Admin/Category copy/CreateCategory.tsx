...
export default function CreateCategory() {
    ...
    return (
        ...
        >
            ...
            <div className="w-full flex  px-24 sm:px-6 lg:px-96 py-6">
                <div className="flex flex-col items-center  min-h-screen py-4 sm:py-8 dark:text-white w-full max-w-7xl">
                    <h1 className="font-bold text-xl sm:text-2xl mb-6 sm:mb-8 text-center">اضافه کردن دسته بندی</h1>
